...
for i in range(1, 4):
    ...
    for step in range(20000, 1000001, 20000):
        ppo_path = os.path.join('Models', 'PPO_Framestack_3', "PPO_"+str(i), "PPO_Framestack_3_"+str(step)+"_steps")
    ...
    os.makedirs("Evaluation/PPO_Framestack_3/PPO_"+str(i), exist_ok=True)  
    outputdf.to_csv("Evaluation/PPO_Framestack_3/PPO_"+str(i)+"/eval_rew_mean.csv")
